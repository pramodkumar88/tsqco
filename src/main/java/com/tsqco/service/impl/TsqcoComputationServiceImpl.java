...
public class TsqcoComputationServiceImpl implements TsqcoComputationService {
    ...
    public void loadEpsData() throws Exception {
        List<TsqcoEpsDTO> intrumentList = tsqcoAngelInstrumentsRepo.findInstrumentsBySymbolSuffix("-EQ");
    ...
    public static Strategy buildStrategy(BarSeries series) {
        // Use the close price of the series
        ClosePriceIndicator closePrice = new ClosePriceIndicator(series);


        // Short-term moving average (e.g., 5-period SMA)
        SMAIndicator shortSma = new SMAIndicator(closePrice, 5);

        // Long-term moving average (e.g., 20-period SMA)
        SMAIndicator longSma = new SMAIndicator(closePrice, 20);

        // Entry rule: shortSma crosses above longSma
        CrossedUpIndicatorRule entryRule = new CrossedUpIndicatorRule(shortSma, longSma);

        // Exit rule: shortSma crosses below longSma
    ...
    public void fetchEPS(List<TsqcoEpsDTO> symbols) throws Exception {
        ...
        for (TsqcoEpsDTO symbol : symbols) {
    ...
    @Override
    public String analyzeBuyorHoldStock(Map<String, List<String>> stockData) {
    ...
    @Override
    public String analyzeSellorHoldStock(Map<String, List<String>> stockData) {
        ...
        log.info(response);
        return response; // Return the final formatted response or error message
    }

    @Override
    public void handleRecommendation(AngelRecommendationDataDTO recommendationData) {
    ...
    public void analyzeStockData(String token) {
        ...
        tasks.add(() -> {
            ...
            DataProcessHelper processHelper = new DataProcessHelper(cacheHelper);
